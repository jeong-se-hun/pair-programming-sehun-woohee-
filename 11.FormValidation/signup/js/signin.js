...
const checkValiable = e => {
  ...
  if (e.target.id === 'signin-userid' || e.target.id === 'signup-userid') {
  ...
  if (e.target.id === 'signin-password' || e.target.id === 'signup-password') {
...
$signInForm.addEventListener('submit', successMassege);
